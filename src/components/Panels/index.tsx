...
const Panels: React.FC<IPanels> = (props: IPanels) => {
  ...
  return (
    <div className={`${styles['panels']} hidden-md-down`} ref={panelsRef}>
      {svgKey ? (
        <svg
          key={svgKey}
            ...
            {Array.from(Array(columnNumber).keys()).map((_, i) => {
              ...
              return (
                <line
                  ...
                  x1={play ? width / 2 : getPosition(i)}
                  x2={play ? width / 2 : getPosition(i)}
                  y1={0}
                  y2={play ? 0 : height}
                  stroke="#d4d4d3"
                >
              ...
              return play ? (
                <g key={i}>
                  ...
                  <g clipPath={`url(#clip-${i})`}>
                    <text
                      x={getPosition(i) + columnWidth / 2}
                      y="40%"
                      style={{ animation: `appear${i} 2s` }}
