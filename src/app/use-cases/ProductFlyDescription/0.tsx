...
const Product0 = () => {
  ...
  const dedicatedIndexesPart2 = useDedicatedWordIndexes([
    [2, 4],
    [1, 3],
    [0, 2],
  ]);
  ...
  return (
    <>
      <AnimateText
        text={translate(
          translations,
          'Texts.animate-text-use-cases-product-0-part-1',
        )}
        dedicatedWordIndexes={[]}
      />
      <AnimateText
        text={translate(
          translations,
          'Texts.animate-text-use-cases-product-0-part-2',
        )}
      ...
      <AnimateText
        text={translate(
          translations,
          'Texts.animate-text-use-cases-product-0-part-3',
        )}
