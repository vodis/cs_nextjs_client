    ...
    return (
        <InfoBox img="/images/home/home_modularity_systems_card.png" title="Modularity Systems" imgPosition="right">
            <section className="flex flex-col gap-2">
                ...
                <p>Our modular systems empower you to seamlessly integrate new functionalities and scale your software architecture without disrupting existing operations. CraftScript's modular approach ensures agility, allowing you to respond rapidly to market changes and customer demands.</p>
                <p>Embrace the future of software development with CraftScript's modularity systems. Experience enhanced flexibility, scalability, and efficiency in your software ecosystem.</p>
            </section>
        </InfoBox>
    );
}
