    ...
    <InfoBox img={homeAiIntegrationCard} title="Content AI">
      <section className="flex flex-col gap-2">
        <h2 className="mt-10 mb-5 text-xl tracking-wide uppercase text-orange">
          <Translate translationKey="Texts.content-ai-integration-title" />
        </h2>
        <p>
          <Translate translationKey="Texts.content-ai-integration-paragraph-1" />
        </p>
        <p>
          <Translate translationKey="Texts.content-ai-integration-paragraph-2" />
        </p>
        <p>
          <Translate translationKey="Texts.content-ai-integration-paragraph-3" />
        </p>
      </section>
    </InfoBox>
  );
